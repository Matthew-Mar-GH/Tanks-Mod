...
public class Nuke extends Ammo {
  public static final int AMMO_SPEED = 12; // 8 faster
  public static final double AMMO_RADIUS = 10000; // 33% increase
  private static final double AMMO_HEIGHT = 4; // 2.75 to 4
  private static final double AMMO_STROKE_WIDTH = 0.05;
  private static final Color AMMO_COLOR_FILL_0 = Color.RED;
  private static final Color AMMO_COLOR_FILL_1 = Color.RED;
  ...
  public Nuke(int playerIdx, Vec2 pos, Vec2 dir, double maxRange) {
