...
public class EndGameTarget extends Target {
    ...
    protected void draw(Graphics2D g) {
		...
		// Body...
			Draw.drawRect(g, this.pos, height, new Vec2(TARGET_RADIUS, TARGET_RADIUS), calcDrawScale(0), colorFillBlue, colorStroke, TARGET_STROKE_WIDTH, TARGET_RADIUS * 2);
			...
			Draw.drawRect(g, this.pos, height, (new Vec2(TARGET_RADIUS, TARGET_RADIUS)).multiply(0.33), calcDrawScale(2), colorFillBlue, colorStroke, 0, TARGET_RADIUS * 2);
