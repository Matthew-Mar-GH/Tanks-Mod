...
public class Simulation {
    ...
    public void createRandTarget(Vec2 pos) {
        GameObject target = new EndGameTarget(pos);
    ...
    protected Ammo createAmmoTwo(int playerIdx, Vec2 pos, Vec2 dir, double maxRange) {
        Ammo ammoTwo = new AmmoSecond(playerIdx, pos, dir, maxRange);
        this.gameObjects.add(ammoTwo);
        return ammoTwo;
    }

    protected Ammo createNuke(int playerIdx, Vec2 pos, Vec2 dir, double maxRange) {
        Ammo nuke = new Nuke(playerIdx, pos, dir, maxRange);
        this.gameObjects.add(nuke);
        return nuke;
    }
